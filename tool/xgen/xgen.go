...
import (
	...
	"github.com/halokid/rpcx-plus/tool/xgen/parser"
)
...
func generate(parsers []*parser.Parser) error {
	...
	fmt.Fprintln(w, `  "github.com/halokid/rpcx-plus/server"`)
	fmt.Fprintln(w, `  "github.com/halokid/rpcx-plus/serverplugin"`)
